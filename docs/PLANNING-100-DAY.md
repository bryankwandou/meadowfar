# Meadowfar — Rencana pengembangan 100 hari

Tujuan: membawa Meadowfar dari purwarupa menjadi permainan dunia terbuka untuk anak yang terasa sekelas game besar — dalam, hidup, dan tanpa rasa bosan — sambil tetap 100% aman untuk anak.

## Fase 1 — Fondasi (hari 1–10) ✅ selesai
- H1–2: Landing page, dunia prosedural tanpa batas, dua tokoh, misi tak berujung.
- H3–4: Lompat, awan, kupu-kupu, kelinci, suara chime, panah misi, rekor lokal.
- H5–7: Basis data Neon Postgres, tabel users + progress, sesi HMAC HttpOnly.
...
1. Tanpa iklan, tanpa pembelian, tanpa chat antar pemain.
2. Tanpa kekerasan — "senjata" selalu berupa alat ramah (jaring, tongkat bintang).
3. Data anak minimum: username, email, progres. Tidak lebih.
4. Semua aset lahir dari kode — nol risiko hak cipta.
